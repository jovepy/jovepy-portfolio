      ...
      <nav>
        ...
        <style jsx>{`
          ...
          <button className="navbar-toggler" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasNavbar" aria-controls="offcanvasNavbar">
            <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="currentColor" className="bi bi-filter-right" viewBox="0 0 16 16" style={{color:"#FFDC4E"}} className='animate-bounce w-10 h-7'>
